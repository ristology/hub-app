...
export default function ErrorLogScreen() {
  ...
  const { data, isLoading, refetch } = useQuery({
    ...
    queryFn:  () => errorLogApi.list(filter === 'semua' ? {} : { status: filter }),
  });
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.center}>
            ...
            <Text style={styles.empty}>Belum ada laporan error.</Text>
          </View>
        }
      />
...
const styles = StyleSheet.create({
  ...
  statsRow:  { flexDirection: 'row', gap: 6, paddingHorizontal: 16, marginBottom: 12 },
  statBox:   {
  ...
  filters:   { flexDirection: 'row', gap: 6, paddingHorizontal: 16, marginBottom: 8, flexWrap: 'wrap' },
  chip: {
