...
const STATUS_STYLE = {
  ...
  ready_for_review: { bg: 'rgba(59,130,246,0.15)', color: '#3b82f6', label: 'Ready for Review' },
...
export default function ErrorLogCard({ log, onPress }: Props) {
  ...
  return (
    <TouchableOpacity activeOpacity={0.7} onPress={onPress} style={[styles.card, log.has_unread_notif && styles.cardUnread]}>
      {log.has_unread_notif && <View style={styles.unreadDot} />}
