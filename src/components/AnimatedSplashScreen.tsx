...
import { Animated, StyleSheet, Dimensions, ImageBackground, View } from 'react-native';
  ...
  return (
    <Animated.View style={[styles.container, { opacity: screenOpacity }]}>
      ...
      <ImageBackground
        ...
        resizeMode="cover"
      >
        {/* Dark overlay so network mesh + text contrast well over the photo */}
...
const styles = StyleSheet.create({
  ...
  bgOverlay: {
    ...StyleSheet.absoluteFillObject,
    backgroundColor: 'rgba(4,10,28,0.45)',
  },
  logo: {
    width:  width * 0.42,
    height: width * 0.42,
